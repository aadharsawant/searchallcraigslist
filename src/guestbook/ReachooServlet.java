...
public class ReachooServlet extends HttpServlet {
	...
	private static final Logger l =  Logger.getLogger(ReachooServlet.class.getName());
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
        	...
        	ClassifiedAdsCodes aSectionCodes =  ClassifiedAdsCodes.getInstance();
...
//        	{
        	//	urlParams = urlParams +"%20and%20category%20%3D%20'"++"'";
//        	}
...
//        	}
         ...
         //	region=region+"bkp";
        	...
        	urlParams = urlParams + "keywords%3D"+query+"%26cid%3D"+aSectionCodes.sectionMap.get(inType)+"%22";
    		...
    		try {
    			...
    			ReechooReadjson aReechooReadjson = new ReechooReadjson();
    		//	resp.getWriter().println( callback + '(' + aCraigsListReadjson.filterJson(aString,offset,limit) +')' );
    			resp.getWriter().println( aReechooReadjson.filterJson(resList,offset,limit,dateList)  );
...
//   	{
   	try
   	{
       url = new URL("http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20rss%20where%20url%20%3D%20%22http%3A%2F%2Fwww.classifiedads.com%2Fsearch.rss%3F"+urlParams+"%20%7C%20sort(field%3D'pubDate'%2Cdescending%3D'true')%20&format=json&callback=");
