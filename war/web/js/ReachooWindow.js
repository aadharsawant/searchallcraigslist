...
var connObjRechoo = new Ext.data.Connection({
    timeout : 240000,
    url : '../all-reachoo',
...
ReachooWindow = function() {
	
	
	 // create the Data Store
	reachoostore = new Ext.data.JsonStore({
       // root: 'users',
       ...
       // idProperty: 'code',
        ...
        proxy:
        	new Ext.data.HttpProxy(connObjRechoo), 
        	//new Ext.data.ScriptTagProxy(connObjBP), 
        	
        
        listeners: {
        	beforeload: function(reachoostore) {
        		reachoostore.baseParams.query = text;
        		reachoostore.baseParams.inType = typeIn;
        		reachoostore.baseParams.addOne = addOne ;
        		reachoostore.baseParams.addTwo = addTwo ;
        		reachoostore.baseParams.addThree = addThree ;
        		reachoostore.baseParams.addFour = addFour ;
        		reachoostore.baseParams.addFive = addFive ;
        		reachoostore.baseParams.hasPic = hasPic ;
        		reachoostore.baseParams.byDate = byDate ;
        		reachoostore.baseParams.region = region ;
        		  
        		
        		
        		},
     
     load:function(reachoostore,records,opts){                    
     ...
     gridreachoo = new Ext.grid.GridPanel({
       layout:'vBox',
     width:700,
      // height:800,
        title:'Reachoo Search Results', 
        region:'west',
        store: reachoostore,
...
//      });
	...
	ReachooWindow.superclass.constructor.call(this, {
    id:'reachooWin',
	title:'All Cliassiedads Search',
	layout:'hBox',
	//height:100,
	layoutConfig: {
	    align : 'stretch',
...
Ext.extend(ReachooWindow, Ext.Panel, {
...
Ext.reg('ReachooWindow', ReachooWindow); 